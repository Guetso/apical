  ...
  <div class="content flex flex-col">
    ...
    <div class="legals absolute">
      ...
      <p>
        ...
        site Apical - Arboriste Grimpeur l'identité des différents intervenants
        dans le cadre de sa réalisation et de son suivi :<br />
        Propriétaire : SAS Apical 89 RTE DE KERHALL 29950 CLOHARS-FOUESNANT<br />
        Numéro SIRET : 913 401 550 00011<br />
        Numéro immatriculation RCS : 913 401 550 R.C.S. Quimper<br />
        Numéro identification TVA : FR58913401550<br />
        Créateur : Hugo Hémon<br />
        Responsable publication : Tristan Jan – apical.elagage29@gmail.com<br />
        Webmaster : Hugo Hémon – hugo.hemon@orange.fr<br />
        Hébergeur : OVH – 2 rue Kellermann - 59100 Roubaix - France<br />
        Crédits : les mentions légales ont été générées et offertes par JBA
      ...
      <p>
        L’utilisation du site Apical - Arboriste Grimpeur implique l’acceptation
        ...
        modifiées ou complétées à tout moment, les utilisateurs du site Apical -
        Arboriste Grimpeur sont donc invités à les consulter de manière
        ...
        être toutefois décidée par Hugo Hémon, qui s’efforcera alors de
        communiquer préalablement aux utilisateurs les dates et heures de
        l’intervention. Le site Apical - Arboriste Grimpeur est mis à jour
        régulièrement par Tristan Jan. De la même façon, les mentions légales
      ...
      <p>
        ...
        Jan s’efforce de fournir sur le site Apical - Arboriste Grimpeur des
        ...
        indiquées sur le site Apical - Arboriste Grimpeur sont données à titre
        indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site Apical - Arboriste Grimpeur ne sont
      ...
      <p>
        ...
        autorisation écrite préalable de : Tristant Jan. Toute exploitation non
      ...
      <p>
        ...
        l’accès au site Apical - Arboriste Grimpeur, et résultant soit de
        ...
        incompatibilité. La société Apical ne pourra également être tenue
        responsable des dommages indirects (tels par exemple qu’une perte de
        marché ou perte d’une chance) consécutifs à l’utilisation du site Apical
        - Arboriste Grimpeur. Des espaces interactifs (possibilité de poser des
        questions dans l’espace contact) sont à la disposition des utilisateurs.
        La société Apical se réserve le droit de supprimer, sans mise en demeure
        ...
        relatives à la protection des données. Le cas échéant, la société Apical
      ...
      <p>
        ...
        L. 226-13 du Code pénal et la Directive Européenne du 24 octobre 1995. A
        l'occasion de l'utilisation du site Apical - Arboriste Grimpeur, peuvent
        êtres recueillies : l'URL des liens par l'intermédiaire desquels
        l'utilisateur a accédé au site Apical - Arboriste Grimpeur, le
        fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
        (IP) de l'utilisateur. En tout état de cause la société Apical ne
        collecte des informations personnelles relatives à l'utilisateur que
        pour le besoin de certains services proposés par le site Apical -
        Arboriste Grimpeur. L'utilisateur fournit ces informations en toute
        connaissance de cause, notamment lorsqu'il procède par lui-même à leur
        saisie. Il est alors précisé à l'utilisateur du site Apical - Arboriste
        Grimpeur l’obligation ou non de fournir ces informations. Conformément
        ...
        l'utilisateur du site Apical - Arboriste Grimpeur n'est publiée à l'insu
        de l'utilisateur, échangée, transférée, cédée ou vendue sur un support
        quelconque à des tiers. Seule l'hypothèse du rachat de la société Apical
        ...
        du site Apical - Arboriste Grimpeur. Le site n'est pas déclaré à la CNIL
        car il n'exploite pas les données personnelles comme indiqué sur cette
        page Les bases de données sont protégées par les dispositions de la loi
      ...
      <p>
        ...
        société Apical. Cependant, la société Apical n’a pas la possibilité de
        vérifier le contenu des sites ainsi visités, et n’assumera en
        conséquence aucune responsabilité de ce fait.<br />
        La navigation sur le site Apical - Arboriste Grimpeur n'entraine pas
